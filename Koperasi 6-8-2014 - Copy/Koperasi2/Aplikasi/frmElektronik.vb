...
#Region "Function"
    ...
    Private Sub tempTandaTerimaBarang()
        ...
        StrSQL = "INSERT INTO TandaTerimaBarang VALUES ('" & antisqli(txtPemNama.Text) & "','" & antisqli(txtKendaraan.Text) & "'"
        StrSQL &= ",'" & antisqli(txtWarna.Text) & "','" & antisqli(txtTipe.Text) & "'"
        ...
        If txtAplikasi.Text.Length = txtAplikasi.MaxLength Then
            ...
            If dt.Rows.Count > 0 Then
                ...
                If stateApp = "UPD" Then
                    ...
                    txtDokumen.Text = dt.Rows(0)("ShortageDoc")
