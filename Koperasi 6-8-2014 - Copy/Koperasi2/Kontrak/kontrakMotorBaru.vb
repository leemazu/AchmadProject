...
Public Class kontrakMotorBaru
    ...
    Private Sub KontrakLoad()
        ...
        StrSQL &= "application.DealerSubs as [DealerSubs],"
        ...
        StrSQL &= "application.DownPayment as [UangMuka],"
        StrSQL &= "application.MarketingCost as [BiayaMarketing],"
        ...
        txtKendaraan.Text = CStr(dt.Rows(0)("MerkKendaraan"))
        txtTipe.Text = CStr(dt.Rows(0)("Tipe"))
        txtWarna.Text = CStr(dt.Rows(0)("Warna"))

        txtPinjaman.Text = ribuan(CStr(dt.Rows(0)("Pinjaman")))
        txtTenor.Text = CStr(dt.Rows(0)("Tenor"))
        txtPremiAsuransi.Text = CStr(dt.Rows(0)("PremiAsuransi"))
        txtDownPayment.Text = ribuan(CStr(dt.Rows(0)("UangMuka")))
        txtAdmin.Text = ribuan(CStr(dt.Rows(0)("Admin")))
        txtPremiAdmin.Text = ribuan(CStr(dt.Rows(0)("PremiAdmin")))
        txtAdminKredit.Text = ribuan(CStr(dt.Rows(0)("AdminKredit")))
        txtDealerSubs.Text = ribuan(CStr(dt.Rows(0)("DealerSubs")))
        txtAdminMurni.Text = ribuan(CStr(CInt(txtAdminKredit.Text) - CInt(txtDealerSubs.Text)))
        ...
        txtMarketingCost.Text = ribuan(CStr(dt.Rows(0)("BiayaMarketing")))
        ...
        Dim isDpPlus As Boolean = True
        Dim isDealerSubs As Boolean = False
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        TabKontrakMesin.txtFlag.Text = "2"
