...
Public Class PelunasanKhusus
    ...
    Private Sub PelunasanKhusus_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ClearForm()
        setTanggal()
    End Sub

    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        frmTabKontrak.txtFlag.Text = "Khusus"
        frmTabKontrak.Show()
    End Sub
    ...
    Private Sub UpdateContract()
        StrSQL = ""
        StrSQL = "Update Contract Set State=4 Where ContractId='" & txtKontrak.Text & "'"
        RunSQL(StrSQL, 0)
    End Sub
    ...
    Private Sub UpdateKwitansi()
        ...
        StrSQL &= "StatusKwitansi ='Terpakai',Alasan='Pelunasan Khusus Nomor Kontrak " & txtKontrak.Text & " Sebesar Rp." & txtBayar.Text & "', "
